        ...
        <div class="main">
            <div class="mainsub">
                <div class="advancedevent">
                    ...
                    You’re ready to add new steps to your reprtoire, as well as 
                    learn the proper technique.This class is constantly changing 
                    since you vote on the dances that get taught.That's right, 
                    you have a say in what you want to learn. $80 pp.

                    <div class="advancedunderline"></div>
        	   </div>
                <div class="advancedpic"></div>
            </div>
        </div>
